...
def KeyFight(chat_ID, op = "Удар\n"):
                 BT = {"inline_keyboard": [
                                [{
                                    "text": "Голова",
                                    "callback_data": "/hithead"
                                },{
                                    "text": "Голова",
                                    "callback_data": "/blockhead"
                                }],
                                [{
                                    "text": "Грудь",
                                    "callback_data": "/hitchest"
                                },{
                                    "text": "Грудь",
                                    "callback_data": "/blockchest"
                                }],
                                [{
                                    "text": "Живот",
                                    "callback_data": "/hitbelly"
                                },{
                                    "text": "Живот",
                                    "callback_data": "/blockbelly"
                                }],
                                [{
                                    "text": "Ноги",
                                    "callback_data": "/hitlegs"
                                },{
                                    "text": "Ноги",
                                    "callback_data": "/blocklegs"
                                }],
                                [{
                                    "text": "↑ Удары 🤜",
                                    "callback_data": "/A0"
...
def edit_fight(chat_ID, op = "Удар\n"):
                 BT = {"inline_keyboard": [
                                [{
                                    "text": "Голова",
                                    "callback_data": "/hithead"
                 ...
                 params = {'chat_id': chat_ID, 'text': op, "reply_markup":json.dumps(BT), "parse_mode":'HTML'}
                 my_l = "https://api.telegram.org/bot1227859397:AAHMyk5SibE7WXo4kYc78nxCjTyCOHxQdVk/editMessageText"
                 r = requests.get(my_l, data=params).json()
                 return r['result']                                 
