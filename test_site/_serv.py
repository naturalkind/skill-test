...
#    
# 1 000 000 + добавляються новые PDF
# Базовый индекс + новый файл
# нужно перенести данные 
# Другое хранилище
# Полнотекстовый поиск
# 
# Доступ 
# Py 3.6-3.7 - threading/asyncio requests => process data => mongodb <=> tornado/aiohttp => client    
# 
# Mongo DB/Redis - 10% виде картинки, 
# adposium.ru
